...
public class AutoAgentTest {
    ...
    public void test_dynamic_multi_step_execution() {
        ...
        userInput = "搜索 springboot 相关知识，生成2个主要内容章节。每个章节要包括课程内容和配套示例代码。并发对应章节创建对md文档，方便小白伙伴学习。";
    ...
    public McpSyncClient stdioMcpClient() {
        var stdioParams = ServerParameters.builder("D:\\Node\\npx.cmd")
                .args("-y", "@modelcontextprotocol/server-filesystem", "D:\\Desktop\\xfg", "D:\\Desktop\\xfg")
                .build();
